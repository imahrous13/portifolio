...
process.env.CONTACT_TO_EMAIL = process.env.CONTACT_TO_EMAIL || 'dest@example.com';
process.env.CONTACT_FROM_EMAIL = process.env.CONTACT_FROM_EMAIL || 'Portfolio <sender@example.com>';
